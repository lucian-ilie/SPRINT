...
#pragma omp critical(writeFile)
  ...
  for (uint64_t a = 0; a < ht_size;
       a++) {    //initialization of hash_table, set the smer as 1090715534754863 as default, since no smer would have 25 digit 1
  ...
  for (boost::unordered_map<int, string>::iterator it = p_id_seq.begin(); it != p_id_seq.end(); it++) {
    ...
    for (uint32_t i = 0; i < (it->second).length(); i++) {
      ...
      switch ((it->second).at(i)) {
        case 'a':
        case 'A': temp_seq64 = (temp_seq64 | 0);
          break;
        case 'r':
        case 'R': temp_seq64 = (temp_seq64 | 1);
          break;
        case 'n':
        case 'N': temp_seq64 = (temp_seq64 | 2);
          break;
        case 'd':
        case 'D': temp_seq64 = (temp_seq64 | 3);
          break;
        case 'c':
        case 'C': temp_seq64 = (temp_seq64 | 4);
          break;
        case 'q':
        case 'Q': temp_seq64 = (temp_seq64 | 5);
          break;
        case 'e':
        case 'E': temp_seq64 = (temp_seq64 | 6);
          break;
        case 'g':
        case 'G': temp_seq64 = (temp_seq64 | 7);
          break;
        case 'h':
        case 'H': temp_seq64 = (temp_seq64 | 8);
          break;
        case 'i':
        case 'I': temp_seq64 = (temp_seq64 | 9);
          break;
        case 'l':
        case 'L': temp_seq64 = (temp_seq64 | 10);
          break;
        case 'k':
        case 'K': temp_seq64 = (temp_seq64 | 11);
          break;
        case 'm':
        case 'M': temp_seq64 = (temp_seq64 | 12);
          break;
        case 'f':
        case 'F': temp_seq64 = (temp_seq64 | 13);
          break;
        case 'p':
        case 'P': temp_seq64 = (temp_seq64 | 14);
          break;
        case 's':
        case 'S': temp_seq64 = (temp_seq64 | 15);
          break;
        case 't':
        case 'T': temp_seq64 = (temp_seq64 | 16);
          break;
        case 'w':
        case 'W': temp_seq64 = (temp_seq64 | 17);
          break;
        case 'y':
        case 'Y': temp_seq64 = (temp_seq64 | 18);
          break;
        case 'v':
        case 'V': temp_seq64 = (temp_seq64 | 19);
          break;
        case 'b':
        case 'B':
        case 'z':
        ...
        case 'U':
        case 'o':
        case 'O': temp_seq64 = (temp_seq64 | 20);
          break;
        default: temp_seq64 = (temp_seq64
              | 31);    //letters which other than 25 amino acids, will be encoded by a largest 5-digit number
          cout
              << "protein seqeunces contains letter(s) other than the 25 Amino Acids(including U and O) as shown here: http://blast.advbiocomp.com/blast-1.3/blast/PAM120"
              << endl;
